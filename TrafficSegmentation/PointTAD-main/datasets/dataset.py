...
class Carom(torch.utils.data.Dataset):    
    def __init__(self, anno_file, frame_file, frame_folder, split, window_size, interval, num_classes, img_tensor, tensor_folder):
        self.window_size = window_size
        self.interval = interval
        self.anno_file = load_json(anno_file)
...
def build_carom(split, args):
    return Carom(args.annotation_path, args.frame_file_path, args.frame_folder, split, args.window_size, args.interval, args.num_classes, args.img_tensor, args.tensor_folder)