...
if dataset == 'multithumos':
    ...
    splits = ['training','testing']
    frame_folder_path = 'data/carom_frames/' # path to rgb frame folder
    tensor_path = 'data/carom_tensors/' # path to image tensor folder
else:
    splits = ['']
...
for split in splits:
    ...
    for vid in tqdm(vid_list):
        ...
        if dataset == 'multithumos' or dataset == 'carom':
