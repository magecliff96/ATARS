...
#models
import ASformer_rus as ASformer
...
class VideoClassificationLightningModule(pytorch_lightning.LightningModule):
    def __init__(self, args):
        ...
        if self.args.arch == "ASformer": #functional
            self.model = ASformer.X3D(num_actor_class=model_num_class, args=self.args)
...
def main():
    ...
    parser.add_argument('--non_as_pos_weight', type=float, default=1, help='') #for non-action-slot, should be 1 for other methods
    parser.add_argument('--bce_pos_weight', type=float, default=10, help='') #originally 1 for others, 10 for AS
