"""
Copy and Paste from AFSD (https://github.com/TencentYoutuResearch/ActionDetection-AFSD)
...
from .layers import MaxPool3dSamePadding
...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True,
                 ...
                 dropout_keep_prob=0.5): #originally 0.5
    ...
    def extract_features(self, x):
        ...
        for end_point in self.VALID_ENDPOINTS:
            if end_point in self.end_points:
                ...
                if end_point in ['Mixed_5c','Mixed_4f']:
...
class I3D_BackBone(nn.Module):
    outdim_5c = 1024
    outdim_4f = 832
    def __init__(self, model_path, final_endpoint='Mixed_5c', name='inception_i3d', in_channels=3,
        ...
        self._model.build()
        self.load_pretrained_weight(model_path)
        self._freeze_bn = freeze_bn
        self._freeze_bn_affine = freeze_bn_affine

    def load_pretrained_weight(self, model_path='ckpt/rgb_imagenet.pt'):
        print("Loading I3D pretrained weight from {}...".format(model_path))
